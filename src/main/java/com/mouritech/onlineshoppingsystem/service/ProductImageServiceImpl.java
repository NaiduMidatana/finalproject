...
public class ProductImageServiceImpl implements ProductImageService{
   ...
   List<ProductImage> images = productimageRepository.findAll();
	...
	@Override
	public ProductImage getImageById(Long imageId) throws ProductImageNotFoundException {
		return productimageRepository.findById(imageId).orElseThrow(()-> new ProductImageNotFoundException("image not found with id " + imageId) );
